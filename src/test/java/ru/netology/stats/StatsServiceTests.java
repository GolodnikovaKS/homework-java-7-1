...
public class StatsServiceTests {
    ...
    @Test
    public void testAverageMonthlySalesAmount() {
        StatsService service = new StatsService();
        long[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
    ...
    @Test
    public void testCountMonthSumBelowAverage() {
        StatsService service = new StatsService();
        long[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;
        int actual = service.countMonthSumBelowAverage(sales);
        Assertions.assertEquals(expected, actual);
    }

    @Test
    public void testCountMonthSumAboveAverage() {
        StatsService service = new StatsService();
        long[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;
        int actual = service.countMonthSumАboveAverage(sales);
        Assertions.assertEquals(expected, actual);
    }
}